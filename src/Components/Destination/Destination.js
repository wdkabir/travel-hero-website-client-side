                    ...
                    <div className="col-md-3">
                        <Col className="card-container">
                            <Card className="h-100 border-0 card-border position-relative my-3">
                                ...
                                <div className="position-absolute bottom-0 left-0 w-100 bg-primary text-center p-3 text-white">
                                    <Card.Title>Austria</Card.Title>
                                </div>
                                <div className="middle">
                                    <div className="card-btn">
                                        <Link to="/packages"><Button variant="primary" className="fs-6 fw-bolder">See Packages</Button></Link>
                                    </div>
                                </div>
